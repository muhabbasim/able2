              ...
              <div className="tl-8-course">
                ...
                <div className="tl-8-course-txt">
                  <div className="tl-8-course-info">
                    ...
                    <span className="tl-8-course-level">
                      <i className="fa-sharp fa-solid fa-signal-bars-good"></i>{" "}
                      Intermediate
                    </span>
                  </div>
                  ...
                  <div className="tl-8-course-parts">
                    <div className="tl-8-course-part">
                      ...
                      <div className="tl-8-course-part-txt">
                        <h6 className="tl-8-course-part-title">
                          Theory Session
                        </h6>
                  ...
                  <Link to={`/course/${item.slug}`} className="tl-def-btn">
                    Read More
                  </Link>
                </div>
              </div>
