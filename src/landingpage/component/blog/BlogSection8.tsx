...
const BlogSection8 = () => {
  ...
  return (
    <section className="tl-12-blogs tl-11-section-spacing">
          ...
          <div className="col-xl-5 col-lg-10 ">
            <div className="tl-12-blogs-txt">
              <div className="tl-12-section-heading tl-12-blogs-heading">
                <h2 className="tl-12-section-title text-white">
                  Latest News Blogs & Articles.
                </h2>
                <p className="tl-12-section-descr  text-white">
                ...
                <div className="tl-12-blogs-slide" key={item.id}>
                  <div className="tl-3-single-blog tl-12-blog">
                    <div className="tl-3-single-blog-img">
                      ...
                      <span className="tl-3-single-blog-tag">
                        {item.category}
                      </span>
                    </div>
                    ...
                    <div className="tl-3-single-blog-txt">
                      ...
                      <h4 className="tl-3-single-blog-title text-white">
                        <Link to={`/blog/${item.id}`}>{item.title}</Link>
                      </h4>
                      <Link
                        to={`/blog/${item.id}`}
                        className="tl-3-single-blog-btn"
                      >
