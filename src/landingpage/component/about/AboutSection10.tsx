          ...
          <div className="col-xxl-7 col-lg-6">
            <div className="tl-13-about-img">
              ...
              <div className="tl-13-about-stat">
                ...
                <span className="tl-13-about-stat-name">
                  years of experience
                </span>
              </div>
            </div>
          ...
          <div className="col-lg-5">
            <div className="tl-13-about-txt">
              ...
              <h2 className="tl-13-section-title">
                Take The World Best Course{" "}
                <span className="last-word">Online</span> For Free.
              </h2>
              <p className="tl-13-about-descr">
                There are many variations of passages of Lorem Ipsum available,
                but the majority have suffered alteration in some form, by
                injected randomised words which don't look even slightly
                believable.
              </p>
              <a href="#" className="tl-13-about-btn">
