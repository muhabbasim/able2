...
const slideData = [
  {
    ...
    description:
      "Explore a creative journey through various forms of art and unleash your artistic potential.",
  ...
  },
  {
    ...
    description:
      "Dive into the fascinating world of science and discover the wonders of the natural universe.",
  ...
  },
  {
    ...
    description:
      "Immerse yourself in the world of literature and let words transport you to new realms of imagination.",
    ...
    <section className="tl-5-banner">
      ...
      >
        {slideData.map((slide, index) => (
          <SwiperSlide
            key={index}
            className={`tl-5-banner-single-slide tl-5-banner-single-slide-${
              index + 1
            }`}
          >
