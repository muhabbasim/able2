  ...
  return (
    <>
      <div className="autoplay-progress">
        ...
        <span role="button" onClick={togglePlayPause}>
          {isPlaying ? (
      ...
      >
        <SwiperSlide>
          <div className="tl-12-testimony">
            <p className="tl-12-testimony-txt">
              Morbi consectetur elementum purus mattis cursus purus vel metus
              iaculis sagittis. Vestibulum molestie bibendum turpis, id luctus
              sem lacinia quis. Quisque sit amet velit sit amet dui hendrerit
              ultricies a id ipsum
            </p>
            ...
            <div className="tl-12-testimony-user">
              ...
              <p className="tl-12-testimony-user-info">
                <span className="tl-12-testimony-user-role">
                  Product Designer
                </span>
                <img
        ...
        <div className="tl-12-testimonial-slider-nav">
          <button className="tl-12-testimonial-slider-prev">
            <i className="fa-regular fa-arrow-left"></i>
          </button>
          <button className="tl-12-testimonial-slider-next">
