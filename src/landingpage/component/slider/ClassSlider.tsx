    ...
    <section className="tl-9-classes tl-9-section-spacing">
      <div className="container">
        <div className="tl-9-section-heading">
          <h2
            className="tl-9-section-title class-slider-section"
            data-text="Our Classes"
          >
          ...
          {courseList.slice(39, 46).map((item) => (
            <SwiperSlide className="tl-9-class tl-9-program" key={item.id}>
              ...
              <img
                src={item.imgSrc}
                alt="class image"
                className="tl-9-class-img"
              />

              <div className="tl-9-class-infos">
                <a href="#" className="tl-9-class-category">
                  instrument
                </a>
              ...
              <Link to={`/course/${item.slug}`} className="tl-9-program-btn">
