  ...
  return (
    <section className="tl-14-software pt-120 pb-120">
      <div className="container">
        <h2 className="tl-14-section-title">
          Want to know More About The Costs of LMS Software?
        </h2>
          ...
          <SwiperSlide className="tl-14-software-slide tl-8-course">
            <div className="tl-8-course-txt">
              ...
              <h3 className="tl-8-course-title">
                Depending on Complexity of The LMS and Needs of The Organization
              </h3>
              <p className="tl-8-course-descr">
                Mauris sit amet lacinia est, vitae tristique metus. Nulla
                facilisi. Mauris tempor nibh vitae pulvinar ultricies. Sed
                malesuada placerat metus. Vivamus sagittis arcu elit semper,
                eget varius turpis posuere.
              </p>
              <a href="#" className="tl-def-btn tl-14-def-btn">
                Read The Article
              </a>
            </div>
        ...
        <div className="tl-14-software-slider-controls position-relative">
          ...
          <div className="tl-14-software-slider-dots"></div>
        </div>
      </div>
    </section>
  );
