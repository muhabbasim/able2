                ...
                <div className="tl-9-event-txt">
                  <div className="tl-3-single-event-info">
                    ...
                    <h6 className="tl-3-single-event-time">
                      <i className="fa-regular fa-clock"></i> {item.startTime} -{" "}
                      {item.endTime}
                    </h6>
                  </div>
                  <h3 className="tl-6-latest-article-title">
                    <Link to={`/event/${item.slug}`}>{item.title}</Link>
                  </h3>
                  <Link to={`/event/${item.slug}`} className="tl-9-event-btn">
                    Get Ticket <i className="fa-regular fa-arrow-right"></i>
                  </Link>
                </div>
              </div>
            </div>
