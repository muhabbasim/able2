...
const HeaderSection9: React.FC<HeaderProp> = ({ lightLogo, darkLogo }) => {
  ...
  return (
    <div className="tl-header kb-10-header pt-30 pb-0">
      <div
        className={`kb-10-top-header ${isHeaderFixed ? "sticky" : ""} pb-30`}
      >
          ...
          <div className="row g-0 align-items-center">
            ...
            <div className="col-xl-4 col-5  d-lg-block d-none">
              <div className="tl-header-actions d-flex justify-content-end">
                <a href="#" className="kb-10-def-btn tl-6-top-header-btn">
                  Subscribe
                </a>
      ...
      <div
        className={`kb-10-bottom-header tl-6-bottom-header ${
          isHeaderFixed ? "sticky" : ""
        } pt-5p pb-5p d-none d-lg-block`}
      >
        <div className="container">
