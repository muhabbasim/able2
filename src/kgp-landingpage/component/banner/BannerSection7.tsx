            ...
            <div className="row">
              <div className="col-xl-7 col-lg-8">
                <div className="tl-8-banner-txt">
                  <h1 className="tl-8-banner-title">
                    Driving School To Your Car is Smarter.
                  </h1>
                  <p className="tl-8-banner-descr">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Curabitur viverra dignissim mollis Suspendisse neque
                    consectetur in mauris fermentum luctus quam.
                  </p>
                  ...
                  <div className="tl-8-banner-btns">
                    ...
                    <a
                      ...
                      onClick={() =>
                        openVideoModal(
                          "https://www.youtube.com/embed/CggXSu_P2GQ?si=YOONcM_FvuR-EQf4"
                        )
                      }
                ...
                <div className="tl-8-banner-txt">
                  ...
                  <div className="tl-8-banner-btns">
                    ...
                    <a
                      ...
                      onClick={() =>
                        openVideoModal(
                          "https://www.youtube.com/embed/vfqx-tB9mvM?si=xJ0qLtKsQadjjrfL"
                        )
                      }
                    >
                      <i className="fa-solid fa-sharp fa-play"></i>
