          ...
          <div className="col-md-8">
            <div className="tl-banner-txt">
              <h1 className="tl-banner-title">
                ...
                <span className="last-word">Kidba</span>.
              </h1>
              <p className="tl-banner-short-descr">
              ...
              <a href="#" className="tl-def-btn">
                More details <i className="fa-regular fa-arrow-right-long"></i>
              </a>
            </div>
          </div>
          ...
          <div className="col-md-4 d-flex align-items-center justify-content-center justify-content-md-end">
            <div className="tl-banner-video">
              <a
                ...
                onClick={() =>
                  openVideoModal(
                    "https://www.youtube.com/embed/LlCwHnp3kL4?si=LaIy6AYATcccYteK"
                  )
                }
              >
        ...
        <div className="row g-0 align-items-end">
          <div className="col-md-3 col-6 col-xxs-12">
            <div className="tl-banner-single-card">
              ...
              <a href="#" className="single-card-action">
