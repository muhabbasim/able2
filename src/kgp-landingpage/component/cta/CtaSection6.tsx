        ...
        <div className="row tl-14-cta-row align-items-center">
          ...
          <div className="col-xxl-5 col-lg-6">
            <div className="tl-14-cta-txt">
              <h2 className="tl-14-section-title tl-14-cta-title">
                Empowering Organizations Through an Effective Learning
                Management System.
              </h2>
              <p className="tl-14-cta-descr">
              ...
              <div className="tl-14-cta-btns">
                ...
                <a href="#" className="tl-14-cta-btn-2">
                  See Online Demo <i className="fa-regular fa-arrow-right"></i>
                </a>
              </div>
