        ...
        <div className="row gx-0 tl-blog-details-row">
          <div className="col-lg-8">
            <div className="tl-event-details-left tl-blog-details-left">
              ...
              <h2 className="tl-event-details-title tl-blog-details-title">
                {blogData.title}
              </h2>
              ...
              <div className="tl-event-details-descr tl-blog-details-descr">
                ...
                <p className="tl-blog-details-descr-txt">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Itaque quo deleniti quae, dolorum aperiam aliquid aliquam,
                  nihil cupiditate officiis ex ipsa? Molestias provident
                  incidunt autem debitis ex, esse sed veritatis!
                </p>

                <p className="tl-blog-details-descr-txt tl-event-details-area">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Laborum unde ducimus soluta iusto nulla sint. Illum aperiam
                  labore nemo fugit possimus laudantium, ab, mollitia
                  perspiciatis ducimus laborum laboriosam culpa minus.
                </p>

                <p className="tl-blog-details-descr-txt">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Voluptas maiores deleniti laudantium accusamus quos
                  necessitatibus fugit totam fugiat rerum quia explicabo
                  blanditiis asperiores velit vero, magni deserunt. Molestias
                  corrupti numquam temporibus, exercitationem architecto,
                  laboriosam vel obcaecati sint placeat modi tempora natus rem
                  consequatur culpa doloremque.
                </p>
              </div>

              <div className="tl-blog-details-bottom-actions">
                <div className="tl-blog-details-tags">
                  <a href="#" className="tl-blog-details-tag">
                    Education
                  </a>
                  <a href="#" className="tl-blog-details-tag">
                    Study
            ...
            <div className="tl-event-details-left tl-blog-details-author mt-30">
              <h3 className="tl-blog-details-author-title tl-event-details-area-title">
                About the Author
              </h3>
              <div className="tl-course-details-instructor tl-event-details-area">
                <div className="tl-course-details-instructor-heading">
                  ...
                  <div className="tl-course-details-instructor-info">
                    ...
                    <h6 className="tl-staff-profile-role">
                ...
                <div className="tl-course-details-instructor-txt">
                  <p className="tl-course-details-instructor-intro">
                    Hello! I'm Brian Cumin, your guide in the "Mastering English
                    Speaking" course. As a seasoned language enthusiast with 03+
                    years of experience, I'm here to help you unlock the world
                    of fluent English communication. Get ready to embark on an
                    exciting journey where we'll build essential skills, explore
                    diverse topics, and boost your confidence in speaking
                    English. Let's make this learning experience impactful and
                    enjoyable together. Ready to get started? Let's dive in!
                  </p>
                </div>
              </div>
            </div>
                  ...
                  {prevArticle && prevArticle.id >= 0 ? (
                    ...
                    <div className="tl-blog-details-bottom-nav">
                      ...
                      <div className="tl-blog-details-bottom-nav-txt">
                        ...
                        <h4 className="tl-blog-details-bottom-nav-title">
                          <Link to="#">No Previous Article</Link>
                        </h4>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="tl-blog-details-bottom-nav tl-blog-details-bottom-nav-next">
                      <div className="tl-blog-details-bottom-nav-txt">
                        ...
                        <h4 className="tl-blog-details-bottom-nav-title">
                          <Link
                            to={`${
                              nextArticle ? `/blog/${nextArticle?.slug}` : "#"
                            }`}
                          >
                            {nextArticle?.title || "No Next Article To Show"}
                          </Link>
                        </h4>
                      </div>
                      <span className="tl-blog-details-bottom-nav-arrow">
            ...
            <div className="tl-event-details-left mt-30">
              <h3 className="tl-event-details-area-title tl-blog-details-author-title">
                Post Comments
              </h3>
              <div className="tl-comment tl-event-details-area">
                <div>
                  <div className="tl-comment-commenter">
                    ...
                    <div className="tl-comment-commenter-txt">
                      ...
                      <h6 className="tl-comment-commenter-date">
                        03 Jan, 2023
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="tl-comment-bottom">
                    <p className="tl-comment-txt">
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                      Officia officiis repellat temporibus quibusdam quisquam!
                      Illum consequatur, ea earum quo explicabo voluptas!
                      Obcaecati ea nobis tenetur voluptatum, pariatur eligendi
                      adipisci nam?
                    </p>

                    <div className="tl-comment-bottom-actions">
                      <button className="tl-comment-like-btn">
                        <i className="fa-regular fa-heart"></i> Like
                      </button>
                      <button className="tl-comment-reply-btn">
                ...
                <div className="tl-comment-reply">
                  <div className="tl-comment-commenter">
                    <div className="tl-comment-commenter-img">
                      <img
                        src="/src/assets/landing-images/tl-4/user-4.jpg"
                        alt="commenter image"
                      />
                    </div>

                    <div className="tl-comment-commenter-txt">
                      <h5 className="tl-comment-commenter-name">
                        Bristy Anam{" "}
                        <span className="tl-comment-commenter-state">
            ...
            <div className="tl-event-details-left mt-30">
              ...
              <form action="#" className="tl-comment-form">
                ...
                <button
                  type="submit"
                  className="tl-def-btn tl-comment-form-btn"
                >
                  Post Comment
                </button>
              </form>
          ...
          <div className="col-lg-4">
            ...
            <div className="tl-event-details-right tl-upcoming-events">
              ...
              <ul>
                <li>
                  <a href="#" className="tl-blog-details-category">
                    <span className="tl-blog-details-category-name">
                      Computer Sceince
                    </span>
