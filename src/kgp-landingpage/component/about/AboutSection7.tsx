          ...
          <div className="col-xl-5 col-lg-6">
            <div className="tl-8-about-txt yellow-clr-hover">
              <h2 className="tl-8-section-title">
                Perfect Driving School With Latest Vehicles.
              </h2>
              ...
              <div className="tl-8-features">
                <div className="tl-8-feature">
                  ...
                  <p className="tl-8-feature-descr">
                    ...
                    form, by injected randomized words which don't look even
                    slightly believable.
                  </p>
                </div>
              ...
              <a href="#" className="tl-def-btn-2">
                More About Us <i className="fa-regular fa-arrow-right-long"></i>
              </a>
            </div>
          </div>
        </div>
