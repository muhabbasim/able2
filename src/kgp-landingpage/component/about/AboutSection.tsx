        ...
        <div className="row align-items-center tl-1-about-row">
          <div className="col-lg-6">
            <div className="tl-1-about-img">
              <img
                src="src/assets/landing-images/kb-16/banner-img.jpg"
                alt="Banner Image"
                className="tl-1-about-main-img"
              />
              <img
                src="src/assets/landing-images/tl-1/sticker.png"
                alt="sticker"
                className="tl-1-about-sticker"
              />
            </div>
          </div>
              ...
              <div className="tl-1-about-author">
                <div className="tl-1-about-author-intro">
                  ...
                  <div className="tl-1-about-author-info">
                    ...
                    <span className="tl-1-about-author-role">
                      Vice Principal
                    </span>
                  </div>
                </div>
