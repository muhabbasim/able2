...
const AboutSection11 = () => {
  ...
  return (
    <section className="tl-14-about pt-120 pb-120">
      <div className="container">
        <div className="row gy-4 align-items-center">
          <div className="col-lg-6">
            <div className="tl-14-about-img">
              <img src="src/assets/landing-images/tl-14/about-img.jpg" alt="Image" />
            </div>
          </div>
          ...
          <div className="col-lg-6">
            <div className="tl-14-about-txt">
              ...
              <h2 className="tl-14-section-title">
                Potential Online Learning Management System.
              </h2>
              ...
              <div className="tl-14-about-actions">
                <div className="tl-14-about-video">
                  <a
                    ...
                    onClick={() =>
                      openVideoModal(
                        "https://www.youtube.com/embed/nUeg_8_L0Bk?si=zAnCRuVPv-g_0s1l"
                      )
                    }
                  >
