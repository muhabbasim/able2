                ...
                >
                  ...
                  <div className="slider-item">
                    <div className="tl-7-about-info-card tl-7-about-timings">
                      <h5 className="tl-7-about-timings-title">
                        Modern & Contemporize Battle
                      </h5>

                      <ul>
                        <li className="tl-7-about-timing">
                          <i className="fa-regular fa-clock"></i>Mon - Fri 8:30
                          - 10:30
                        </li>
                        <li className="tl-7-about-timing">
                          <i className="fa-regular fa-clock"></i>Sat - Fri 10:30
                          - 8:30
                        </li>
                        <li className="tl-7-about-timing">
                          <i className="fa-regular fa-clock"></i>Sunday Holiday
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div className="tl-7-about-info-card tl-7-about-stat-card">
                      ...
                      <h6>
                        <span className="number">
                          23<i className="fa-regular fa-sharp fa-plus"></i>
                        </span>{" "}
                        years of experience
                      </h6>
                    </div>
            ...
            <div className="col-lg-6">
              <div className="tl-7-section-heading tl-7-about-heading yellow-clr">
                ...
                <h2 className="tl-7-section-title">
                  ...
                  <span className="last-word">Numerous</span>.
                </h2>
                <p className="tl-7-about-descr">
                  There are many variations of passages of Lorem Ipsum
                  available, but majority have suffered alteration in some form,
                  by injected randomized words which don't look even slightly
                  believable.
                </p>
